...
for epoch in range(1, epochs + 1):
    for batch_index, (padded_questions_in_batch, padded_answers_in_batch) in enumerate(split_into_batches(training_questions, training_answers, batch_size)):
        ...
        if batch_index % batch_index_check_training_loss == 0:
            print('Epoch: {:>3}/{}, Batch:{:>4}/{}, Training Loss Errors: {:>6.3f}, Training time on 100 Batches: {:d} seconds'.format(epoch,
                                                                                                                                       epochs,
                                                                                                                                       batch_index,
        ...
        if batch_index % batch_index_check_validation_loss == 0 and batch_index > 0:
            ...
            print('Validation Loss Error: {:>6.3f}, Batch Validation Time: {:d} seconds'.format(average_validation_loss_error, int(batch_time * 100)))
            ...
            if average_validation_loss_error <= min(list_validation_loss_error):
                ...
                if early_stopping_check == early_stopping_stop:
                    break
    if early_stopping_check == early_stopping_stop:
        print("Mt apologize, I cannot speak better anymore. This is the best I can do.")
        break
print("Game over")
